...
import { LayoutDashboard, MessageSquare, Settings, Users, LogOut, Package, ClipboardList, Menu } from "lucide-react";
      ...
      <Sheet open={open} onOpenChange={setOpen}>
        <SheetContent side="left" showCloseButton={false} className="w-72 p-0 flex flex-col">
          ...
          <div className="px-6 pt-6 pb-4 border-b border-primary/10">
            ...
            <span className="text-[10px] font-bold uppercase tracking-widest text-primary/60 mt-1 block">Admin Control</span>
          </div>
