...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-full items-center justify-between gap-2 rounded-xl border border-input bg-background/60 py-2.5 pr-3 pl-3.5 text-sm font-medium whitespace-nowrap transition-all outline-none select-none",
        ...
        "data-[size=default]:h-11 data-[size=sm]:h-8 data-[size=sm]:rounded-lg data-[size=sm]:text-xs",
